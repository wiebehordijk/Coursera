...
public class Solver {
    ...
    private void solveChoco() {
        ...
        IntVar[] facilityCost = model.intVarArray(numFacilities, 0, MAX_COST, true);
        IntVar[] customerCost = model.intVarArray(numCustomers, 0, MAX_COST, true);
        ...
        for (int i = 0; i < numFacilities; i++) {
            ...
            model.times(facOpen[i], setupCost[i], facilityCost[i]).post();
        ...
        IntVar sumCustomers = model.intVar(0, MAX_TOTALCOST);
    ...
    private void readFile(String filename) {
        ...
        setupCost = new int[numFacilities];
