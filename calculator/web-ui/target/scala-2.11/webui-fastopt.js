...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var refName = x3.name$2;
      var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(refName, references);
      var temp$references = $as_sci_Map(references.$$minus__O__sc_Map(refName));
      expr = temp$expr;
...
$c_Lcalculator_Polynomial$.prototype.calculator$Polynomial$$solutions__D__D__D__sci_Set = (function(a, b, delta) {
  if ((delta < 0)) {
    ...
    var array$1 = [(((-b) - $uD($g["Math"]["sqrt"](delta))) / (2 * a)), (((-b) + $uD($g["Math"]["sqrt"](delta))) / (2 * a))];
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      return $m_Lcalculator_Polynomial$().calculator$Polynomial$$solutions__D__D__D__sci_Set($uD(a$2.apply__O()), $uD(b$2.apply__O()), $uD(delta$1.apply__O()))
    })
  })(a, b, delta));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_Polynomial$.prototype.calculator$Polynomial$$delta__D__D__D__D = (function(a, b, c) {
  return ((b * b) - ((4 * a) * c))
});
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      return $m_Lcalculator_Polynomial$().calculator$Polynomial$$delta__D__D__D__D($uD(a$1.apply__O()), $uD(b$1.apply__O()), $uD(c$1.apply__O()))
    })
  })(a, b, c));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$countToColor__I__T = (function(count) {
  return ((count >= 15) ? "green" : ((count >= 0) ? "orange" : "red"))
});
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return $m_Lcalculator_TweetLength$().calculator$TweetLength$$countToColor__I__T($uI(remainingCharsCount$1.apply__O()))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
