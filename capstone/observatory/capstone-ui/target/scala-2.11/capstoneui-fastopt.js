...
$c_Lobservatory_Interaction2$.prototype.init___ = (function() {
  ...
  this.TemperatureColors$1 = array;
  ...
  var array$1 = $newArrayObject($d_T2.getArrayOf(), [len$1]);
  var elem$1$1 = 0;
  elem$1$1 = 0;
  ...
  this.DeviationColors$1 = array$1;
  return this
});
$c_Lobservatory_Interaction2$.prototype.yearSelection__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, sliderValue) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(sliderValue$1, bounds$1) {
    return (function() {
      ...
      var that = $as_sci_Range(bounds$1.apply__O()).start$4;
      var x$1 = ((x > that) ? x : that);
      var that$1 = $as_sci_Range(bounds$1.apply__O()).end$4;
...
$c_Lobservatory_Interaction2$.prototype.availableLayers__sc_Seq = (function() {
  $m_sci_List$();
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lobservatory_Layer().init___Lobservatory_LayerName__sc_Seq__sci_Range($m_Lobservatory_LayerName$Temperatures$(), $m_s_Predef$().wrapRefArray__AO__scm_WrappedArray(this.TemperatureColors$1), new $c_sci_Range$Inclusive().init___I__I__I(1975, 2015, 1)), new $c_Lobservatory_Layer().init___Lobservatory_LayerName__sc_Seq__sci_Range($m_Lobservatory_LayerName$Deviations$(), $m_s_Predef$().wrapRefArray__AO__scm_WrappedArray(this.DeviationColors$1), new $c_sci_Range$Inclusive().init___I__I__I(1990, 2015, 1))]);
...
$c_Lobservatory_Interaction2$.prototype.layerUrlPattern__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, selectedYear) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$1, selectedYear$1) {
    return (function() {
      return (((("target/" + $as_Lobservatory_Layer(selectedLayer$1.apply__O()).layerName$1) + "/") + selectedYear$1.apply__O()) + "/{z}/{x}-{y}.png")
    })
...
$c_Lobservatory_Interaction2$.prototype.caption__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, selectedYear) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$3, selectedYear$2) {
    return (function() {
      return ((($as_Lobservatory_Layer(selectedLayer$3.apply__O()).layerName$1.id$1 + " (") + selectedYear$2.apply__O()) + ")")
    })
  })(selectedLayer, selectedYear));
  return new $c_Lobservatory_Signal().init___F0(expr)
});
