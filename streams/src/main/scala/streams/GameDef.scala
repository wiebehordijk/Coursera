...
trait GameDef {
  ...
  case object Left extends Move {
    def apply(b: Block): Block = {
      if (b.isStanding) b.dy(-2, -1)
      else if (b.b1.x == b.b2.x) b.dy(-1, -2)
      else b.dy(-1, -1)
    }
  }
  ...
  case object Right extends Move {
    def apply(b: Block): Block = {
      if (b.isStanding) b.dy(1, 2)
      else if (b.b1.x == b.b2.x) b.dy(2, 1)
      else b.dy(1, 1)
    }
  }
  ...
  case object Up extends Move {
    def apply(b: Block): Block = {
      if (b.isStanding) b.dx(-2, -1)
      else if (b.b1.x == b.b2.x) b.dx(-1, -1)
      else b.dx(-1, -2)
    }
  }
  ...
  case class Path(history: List[Move], endState: Block) {
